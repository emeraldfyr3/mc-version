...
execute if score minor mcversion matches 16 run function mcversion:helpers/player_check
...
execute if score minor mcversion matches 15 if score patch mcversion matches 0 run function mcversion:helpers/player_check
