...
execute store result score #var1 mcversion run data get entity @e[type=minecraft:trader_llama,y=-99,dy=1,limit=1] DespawnDelay
...
execute if score #var1 mcversion matches 1.. run scoreboard players set patch mcversion 2
