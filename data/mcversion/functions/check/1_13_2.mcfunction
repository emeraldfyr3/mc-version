...
execute unless entity @p unless score disable_delayed mcversion matches 1 unless score disable_player mcversion matches 1 run scoreboard players set #playercheck mcversion 1

# Everything below this point is the old 1.13.2 check that I couldn't get to work.
