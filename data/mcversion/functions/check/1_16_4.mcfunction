...
execute unless entity @e[type=minecraft:ender_dragon,tag=mcversion] at @e[limit=1] run summon minecraft:ender_dragon ~ -59 ~ {PersistenceRequired:1b,Silent:1b,Tags:["mcversion"]}
...
execute unless entity @e[type=minecraft:ender_dragon,tag=mcversion] unless score #1_16_4__loaded mcversion matches 1 run forceload add 357704 1025512
execute unless entity @e[type=minecraft:ender_dragon,tag=mcversion] run summon minecraft:ender_dragon 357704 -59 1025512 {Silent:1b,Tags:["mcversion"]}
