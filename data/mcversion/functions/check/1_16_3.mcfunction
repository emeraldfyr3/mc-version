...
execute at @p store result score #1_16_3__mobLoot mcversion run gamerule doMobLoot
execute at @p if score #1_16_3__mobLoot mcversion matches 0 run gamerule doMobLoot true
...
data modify entity @e[type=minecraft:arrow,tag=mcversion,limit=1] Owner set from entity @p UUID
