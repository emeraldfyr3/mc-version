...
execute at @e[type=minecraft:piglin,tag=mcversion,limit=1] unless entity @e[type=minecraft:item,nbt={Item:{tag:{display:{Name:"{\"text\":\"mcversion\"}"}}}},limit=1] run schedule function mcversion:helpers/1_16_3_count 1
