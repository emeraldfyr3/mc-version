...
execute if score minor mcversion matches 16 if score patch mcversion matches 2 unless score disable_delayed mcversion matches 1 unless score disable_entities mcversion matches 1 run function mcversion:check/1_16_4
execute if score minor mcversion matches 16 if score patch mcversion matches 2 unless score disable_entities mcversion matches 1 run function mcversion:check/1_16_3
...
execute if score minor mcversion matches 13 if score patch mcversion matches 1 unless score disable_entities mcversion matches 1 run function mcversion:check/1_13_2
